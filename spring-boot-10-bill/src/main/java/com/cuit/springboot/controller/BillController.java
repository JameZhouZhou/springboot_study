...
public class BillController {
    ...
    public String list(Map<String, Object> map, Bill bill) {
        ...
        System.out.println("1+"+bill.getBillName()+ "2+"+bill.getPid()+"3+"+bill.getPay());
        ...
        System.out.println("billProviders"+billProviders);
...
//        System.out.println("aa+"+bill.getBillName()+ "bb+"+bill.getPid()+"cc+"+bill.getPay());
        return "bill/list";
